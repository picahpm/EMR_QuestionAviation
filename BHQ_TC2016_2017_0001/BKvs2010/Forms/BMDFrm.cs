...
{
    public partial class BMDFrm : CheckupInheriteFrm
    {
        public BMDFrm()
        {
            InitializeComponent();
        ...
        private void BMDFrm_tpridChanged(object sender, int? e, tpr_idStatus? status)
        {
            if (e == null)
            {
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        bmdUC1.PatientRegis = PatientRegis;
                ...
                {
                    Program.MessageError(this.Name, "BMDFrm_tpridChanged", ex, false);
                }
            }
        }
        private void BMDFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                ...
                else
                {
                    ...
                    {
                        Program.MessageError(this.Name, "BMDFrm_mrdidChanged", ex, false);
                    }
                }
            }
        }
