...
{
    public partial class MammogramFrm : CheckupInheriteFrm
    {
        public MammogramFrm()
        {
            InitializeComponent();
        ...
        private void MammogramFrm_tpridChanged(object sender, int? e, CheckupInheriteFrm.tpr_idStatus? status)
        {
            if (e == null)
            {
                ...
                mammogramUC1.PatientRegis = null;
                StatusEmptyRoom();
            }
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        mammogramUC1.PatientRegis = PatientRegis;
                ...
                {
                    Program.MessageError(this.Name, "MammogramFrm_tpridChanged", ex, false);
                }
            }
        }
        private void MammogramFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                ...
                else
                {
                    ...
                    {
                        Program.MessageError(this.Name, "MammogramFrm_mrdidChanged", ex, false);
                    }
                }
            }
        }
