...
{
    public partial class HearingFrm : CheckupInheriteFrm
    {
        public HearingFrm()
        {
            InitializeComponent();
        ...
        private void HearingFrm_tpridChanged(object sender, int? e, CheckupInheriteFrm.tpr_idStatus? status)
        {
            if (e == null)
            {
            ...
            else
            {
                ...
                {
                    Program.MessageError(this.Name, "HearingFrm_tpridChanged", ex, false);
                }
            }
        }
        private void HearingFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                ...
                else
                {
                    ...
                    {
                        Program.MessageError(this.Name, "HearingFrm_mrdidChanged", ex, false);
                    }
                }
            }
        }
