...
{
    public partial class ABIFrm : CheckupInheriteFrm
    {
        public ABIFrm()
        {
            InitializeComponent();
        ...
        private void ABIFrm_tpridChanged(object sender, int? e, tpr_idStatus? status)
        {
            if (e == null)
            {
        ...
        private void ABIFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
