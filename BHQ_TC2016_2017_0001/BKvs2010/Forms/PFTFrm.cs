...
{
    public partial class PFTFrm : CheckupInheriteFrm
    {
        public PFTFrm()
        {
            InitializeComponent();
        ...
        private void PFTFrm_tpridChanged(object sender, int? e, CheckupInheriteFrm.tpr_idStatus? status)
        {
            if (e == null)
            {
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        tabPftUC1.isDoctor = true;
                        tabPftUC1.PatientRegis = PatientRegis;
                ...
                {
                    Program.MessageError(this.Name, "ABIFrm_tpridChanged", ex, false);
                }
            }
        }
        private void PFTFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                ...
                else
                {
                    ...
                    {
                        Program.MessageError(this.Name, "ABIFrm_mrdidChanged", ex, false);
                    }
                }
            }
        }
        ...
        private void btnSendDoc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string result = new EmrClass.DocScan.SendToDocScanCls().Send(Program.CurrentRegis.tpr_id, "PF101", Program.CurrentSite.mhs_code, Program.CurrentUser.mut_username);
