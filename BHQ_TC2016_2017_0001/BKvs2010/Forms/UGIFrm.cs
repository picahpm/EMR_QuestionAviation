...
{
    public partial class UGIFrm : CheckupInheriteFrm
    {
        public UGIFrm()
        {
            InitializeComponent();
        ...
        private void UGIFrm_tpridChanged(object sender, int? e, CheckupInheriteFrm.tpr_idStatus? status)
        {
            if (e == null)
            {
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        ugiUC1.PatientRegis = PatientRegis;
                ...
                {
                    Program.MessageError(this.Name, "UGIFrm_tpridChanged", ex, false);
                }
            }
        }
        private void UGIFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                ...
                else
                {
                    ...
                    {
                        Program.MessageError(this.Name, "UGIFrm_mrdidChanged", ex, false);
                    }
                }
            }
        }
