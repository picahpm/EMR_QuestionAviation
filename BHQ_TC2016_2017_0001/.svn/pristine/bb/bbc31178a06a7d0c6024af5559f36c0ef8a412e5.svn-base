...
{
    public partial class CarotidFrm : CheckupInheriteFrm
    {
        public CarotidFrm()
        {
            InitializeComponent();
        ...
        private void CarotidFrm_tpridChanged(object sender, int? e, tpr_idStatus? status)
        {
            if (e == null)
            {
        ...
        private void CarotidFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
