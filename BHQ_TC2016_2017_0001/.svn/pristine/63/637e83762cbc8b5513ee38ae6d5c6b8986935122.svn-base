...
{
    public partial class ESTFrm : CheckupInheriteFrm
    {
        public ESTFrm()
        {
            InitializeComponent();
        ...
        private void EKGFrm_tpridChanged(object sender, int? e, CheckupInheriteFrm.tpr_idStatus? status)
        {
            if (e == null)
            {
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        //abiUC1.PatientRegis = PatientRegis;
                ...
                {
                    Program.MessageError(this.Name, "EKGFrm_tpridChanged", ex, false);
                }
            }
        }
        private void EKGFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                ...
                else
                {
                    ...
                    {
                        Program.MessageError(this.Name, "EKGFrm_mrdidChanged", ex, false);
                    }
                }
            }
        }
            ...
            try
            {
                ...
                else
                {
                    if (new Class.FunctionDataCls().ChkSendAutoNewModule(Program.CurrentRegis))
                    {
                        ...
                        //{
                        //    WS_PathWay.SendAutoResult result = ws.SendAuto((int)tps_id, new List<int> { 17 }.ToArray(), user.mut_username, Program.CurrentSite.mhs_id);
                        ...
                        //                                    Program.CurrentRoom.mrd_ename,
                        //                                    Program.CurrentUser.mut_username,
                        //                                    Convert.ToDecimal((DateTime.Now - startDate).TotalMilliseconds));
