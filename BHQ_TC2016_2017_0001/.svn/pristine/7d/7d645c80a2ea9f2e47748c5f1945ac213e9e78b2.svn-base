...
{
    public partial class DentalFrm : CheckupInheriteFrm
    {
        public DentalFrm()
        {
            InitializeComponent();
        ...
        private void DentalFrm_tpridChanged(object sender, int? e, tpr_idStatus? status)
        {
            if (e == null)
            {
        ...
        private void DentalFrm_mrdidChanged(object sender, int? e)
        {
            if (this.FormStatus == formStatus.isStation)
            {
                if (e == null)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (result == StatusTransaction.True || result == StatusTransaction.SendCheckB)
                            {
                                ...
                                else if (result == StatusTransaction.SendCheckB)
                                {
                                    new Class.logPatientFlowCls(Class.logPatientFlowCls.sendType.SendCheckB,
                                                                (int)tpr_id,
                                                                (int)tps_id,
