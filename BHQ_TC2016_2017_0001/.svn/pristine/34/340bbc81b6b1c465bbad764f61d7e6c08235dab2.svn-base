...
namespace BKvs2010.Forms
{
    public partial class CheckupInheriteFrm : Form
    {
                ...
                if (value != _mrd_id)
                {
                    if (value != null)
                    {
                        if (this.FormStatus == formStatus.isStation)
                        {
                            using (InhCheckupDataContext context = new InhCheckupDataContext())
                            {
                                mhs_id = context.mst_room_dtls
                                                .Where(x => x.mrd_id == value)
                                                .Select(x => x.mst_room_hdr.mhs_id)
                                                .FirstOrDefault();
        ...
        protected ToolStripMenuItem pathoResultToolStripMenuItem;
        protected ToolStripMenuItem linkApproveToolStripMenuItem;
        private void InitializeComponent()
        {
            ...
            this.pathoResultToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.linkApproveToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.pathoResultToolStripMenuItem,
            this.linkApproveToolStripMenuItem});
            ...
            // 
            // pathoResultToolStripMenuItem
            // 
            this.pathoResultToolStripMenuItem.Name = "pathoResultToolStripMenuItem";
            this.pathoResultToolStripMenuItem.Size = new System.Drawing.Size(85, 20);
            this.pathoResultToolStripMenuItem.Text = "Patho Result";
            this.pathoResultToolStripMenuItem.Visible = false;
            this.pathoResultToolStripMenuItem.Click += new System.EventHandler(this.pathoResultToolStripMenuItem_Click);
            // 
            // linkApproveToolStripMenuItem
            // 
            this.linkApproveToolStripMenuItem.Name = "linkApproveToolStripMenuItem";
            this.linkApproveToolStripMenuItem.Size = new System.Drawing.Size(136, 20);
            this.linkApproveToolStripMenuItem.Text = "Link to Approve Book. (0)";
            this.linkApproveToolStripMenuItem.Visible = false;
            this.linkApproveToolStripMenuItem.Click += new System.EventHandler(this.linkApproveToolStripMenuItem_Click);
            // 
            // CheckupInheriteFrm
            // 
        ...
        private void pathoResultToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (Forms.PapResultFrm frm = new PapResultFrm())
            {
                frm.user = Program.CurrentUser;
                frm.ShowDialog();
            }
        }
